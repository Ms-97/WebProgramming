...
function proc3(){
	...
	let result = `입력한 값 : ${str} <br>결과 : ${sum}`;
	document.getElementsByTagName('div')[2].innerHTML = result;
}

//다중for문으로 1~10까지의 두 수의 합이 3의 배수인 값 출력(continue)
function proc4(){
	let result="";
...
//1~100 까지 중 2의 배수이자, 3의 배수인 값 출력
function proc5(){
	let result="";
...
function proc6(){
	let str1="100이상의 값 <br>";
	let str2="100미만의 값 <br>";
